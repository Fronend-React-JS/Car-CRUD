import {form, nameForm, yearForm, priceForm, colorForm, addBtn, nameFilter, yearFilter, statusFilter, search, tbody} from "./consts.js";
...
nameFilter && nameFilter.addEventListener('change', function() {
    ...
    tbody.innerHTML = '';
    let filterFakeDom ='';
    filteredData && filteredData.forEach((car, index)=> {
        let tr = createRow(car, index);
        filterFakeDom += tr;
    })
